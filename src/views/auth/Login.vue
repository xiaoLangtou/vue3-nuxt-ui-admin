...
<template>
  ...
  <div class="bg-neutral-0 dark:bg-neutral-900 min-h-screen w-full flex overflow-hidden text-gray-900 dark:text-gray-0">
    <!-- 左侧视觉区域 -->
      ...
      <div class="relative z-10 flex flex-col items-center text-center px-12">
        <div class="mb-12 relative">
          ...
          <img
            ...
            class="w-[400px] relative z-10 drop-shadow-2xl animate-float" alt="Illustration"
          >
        </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 relative">
      ...
      <div class="w-full max-w-[420px] space-y-8">
        ...
        <UForm :validate="validate" :state="state" class="space-y-5" @submit="onSubmit">
          <!-- 账号 -->
          <UFormField label="账号" name="username" required class="w-full text-base">
            <UInput
          ...
          <!-- 密码 -->
          <UFormField label="密码" name="password" required class="text-base">
            <UInput
          ...
          <!-- 验证码 -->
          <UFormField label="验证码" name="captcha" required class="text-base">
            <div class="flex gap-3 items-center">
              ...
              <div class="relative shrink-0">
                ...
                >
                  ...
                  >
                    <UIcon name="i-lucide-refresh-cw" class="mr-1 animate-spin" />
                    获取中
                  </div>
                  ...
                  >
                    <UIcon name="i-lucide-alert-circle" class="mb-1 text-orange-400" />
          ...
          <div class="flex items-center justify-between ">
            ...
            <UButton variant="link" color="primary" label="忘记密码？" />
          </div>
